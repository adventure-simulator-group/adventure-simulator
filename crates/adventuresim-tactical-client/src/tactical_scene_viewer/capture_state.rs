...
pub(super) struct CaptureState {
    ...
    pub(super) expected_terrain_patches: usize,
    ...
    pub(super) terrain_patch_camera: Option<Vec3>,
    pub(super) terrain_patch_focus: Option<Vec3>,
    pub(super) terrain_patch_profile_camera: Option<Vec3>,
    pub(super) terrain_patch_profile_focus: Option<Vec3>,
