    ...
    commands.spawn((
        ...
        children![
            ...
            (
                Name::new("controls"),
                Text::new(
                    "WASD to move | Caps Lock: jog | Shift: sprint | Space to jump | Release Ctrl: prone/get up | Downed WASD: tank controls | Hold Space: align with camera | Hold Space + A/D: keep rolling | Ctrl + release Space: dive | Mouse to look around | F9 to toggle camera\n",
                ),
                #[cfg(feature = "debug")]
                children![
                    TextSpan::new(
