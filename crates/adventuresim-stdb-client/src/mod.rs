...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            ...
            Reducer::SetSimulationNpcInterventionStrategy { .. } => "set_simulation_npc_intervention_strategy",
...
impl TryFrom<__ws::v2::TransactionUpdate> for DbUpdate {
    ...
    "backend_automatic_social_chats" => db_update.backend_automatic_social_chats.append(backend_automatic_social_chats_table::parse_table_update(table_update)?),
    ...
    "backend_forage_receipts" => db_update.backend_forage_receipts.append(backend_forage_receipts_table::parse_table_update(table_update)?),
    "backend_investigation_action_outcomes" => db_update.backend_investigation_action_outcomes.append(backend_investigation_action_outcomes_table::parse_table_update(table_update)?),
    "backend_investigation_actions" => db_update.backend_investigation_actions.append(backend_investigation_actions_table::parse_table_update(table_update)?),
    "backend_investigation_cases" => db_update.backend_investigation_cases.append(backend_investigation_cases_table::parse_table_update(table_update)?),
    ...
    "backend_local_chat_messages" => db_update.backend_local_chat_messages.append(backend_local_chat_messages_table::parse_table_update(table_update)?),
    ...
    "backend_npc_case_interventions" => db_update.backend_npc_case_interventions.append(backend_npc_case_interventions_table::parse_table_update(table_update)?),
    "backend_npc_intervention_candidates" => db_update.backend_npc_intervention_candidates.append(backend_npc_intervention_candidates_table::parse_table_update(table_update)?),
    "backend_physical_evidence" => db_update.backend_physical_evidence.append(backend_physical_evidence_table::parse_table_update(table_update)?),
    "backend_physical_evidence_inspections" => db_update.backend_physical_evidence_inspections.append(backend_physical_evidence_inspections_table::parse_table_update(table_update)?),
    "backend_physiology_administrations" => db_update.backend_physiology_administrations.append(backend_physiology_administrations_table::parse_table_update(table_update)?),
    "backend_physiology_charts" => db_update.backend_physiology_charts.append(backend_physiology_charts_table::parse_table_update(table_update)?),
    "backend_social_addresses" => db_update.backend_social_addresses.append(backend_social_addresses_table::parse_table_update(table_update)?),
    ...
    "starting_character_claim" => db_update.starting_character_claim.append(starting_character_claim_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(&self, cache: &mut __sdk::ClientCache<RemoteModule>) -> AppliedDiff<'_> {
        ...
        diff.starting_character_claim = cache.apply_diff_to_table::<StartingCharacterClaim>("starting_character_claim", &self.starting_character_claim).with_updates_by_pk(|row| &row.request_key);
        ...
        diff.backend_automatic_social_chats = cache.apply_diff_to_table::<AutomaticSocialChat>("backend_automatic_social_chats", &self.backend_automatic_social_chats);
        ...
        diff.backend_forage_receipts = cache.apply_diff_to_table::<BackendForageReceipt>("backend_forage_receipts", &self.backend_forage_receipts);
        diff.backend_investigation_action_outcomes = cache.apply_diff_to_table::<BackendInvestigationActionOutcome>("backend_investigation_action_outcomes", &self.backend_investigation_action_outcomes);
        diff.backend_investigation_actions = cache.apply_diff_to_table::<BackendInvestigationAction>("backend_investigation_actions", &self.backend_investigation_actions);
        diff.backend_investigation_cases = cache.apply_diff_to_table::<BackendInvestigationCaseSummary>("backend_investigation_cases", &self.backend_investigation_cases);
        ...
        diff.backend_local_chat_messages = cache.apply_diff_to_table::<BackendLocalChatMessage>("backend_local_chat_messages", &self.backend_local_chat_messages);
        ...
        diff.backend_npc_case_interventions = cache.apply_diff_to_table::<BackendNpcCaseIntervention>("backend_npc_case_interventions", &self.backend_npc_case_interventions);
        diff.backend_npc_intervention_candidates = cache.apply_diff_to_table::<BackendNpcInterventionCandidate>("backend_npc_intervention_candidates", &self.backend_npc_intervention_candidates);
        diff.backend_physical_evidence = cache.apply_diff_to_table::<BackendPhysicalEvidence>("backend_physical_evidence", &self.backend_physical_evidence);
        diff.backend_physical_evidence_inspections = cache.apply_diff_to_table::<BackendPhysicalEvidenceInspection>("backend_physical_evidence_inspections", &self.backend_physical_evidence_inspections);
        diff.backend_physiology_administrations = cache.apply_diff_to_table::<BackendPhysiologyAdministration>("backend_physiology_administrations", &self.backend_physiology_administrations);
        diff.backend_physiology_charts = cache.apply_diff_to_table::<BackendPhysiologyChart>("backend_physiology_charts", &self.backend_physiology_charts);
        diff.backend_social_addresses = cache.apply_diff_to_table::<SocialAddress>("backend_social_addresses", &self.backend_social_addresses);
...
for table_rows in raw.tables {
            match &table_rows.table[..] {
                ...
                "backend_automatic_social_chats" => db_update.backend_automatic_social_chats.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                ...
                "backend_forage_receipts" => db_update.backend_forage_receipts.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "backend_investigation_action_outcomes" => db_update.backend_investigation_action_outcomes.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "backend_investigation_actions" => db_update.backend_investigation_actions.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "backend_investigation_cases" => db_update.backend_investigation_cases.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                ...
                "backend_local_chat_messages" => db_update.backend_local_chat_messages.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                ...
                "backend_npc_case_interventions" => db_update.backend_npc_case_interventions.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "backend_npc_intervention_candidates" => db_update.backend_npc_intervention_candidates.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "backend_physical_evidence" => db_update.backend_physical_evidence.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "backend_physical_evidence_inspections" => db_update.backend_physical_evidence_inspections.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "backend_physiology_administrations" => db_update.backend_physiology_administrations.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "backend_physiology_charts" => db_update.backend_physiology_charts.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "backend_social_addresses" => db_update.backend_social_addresses.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                ...
                "starting_character_claim" => db_update.starting_character_claim.append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
...
for table_rows in raw.tables {
            match &table_rows.table[..] {
                ...
                "backend_automatic_social_chats" => db_update.backend_automatic_social_chats.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                ...
                "backend_forage_receipts" => db_update.backend_forage_receipts.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "backend_investigation_action_outcomes" => db_update.backend_investigation_action_outcomes.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "backend_investigation_actions" => db_update.backend_investigation_actions.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "backend_investigation_cases" => db_update.backend_investigation_cases.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                ...
                "backend_local_chat_messages" => db_update.backend_local_chat_messages.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                ...
                "backend_npc_case_interventions" => db_update.backend_npc_case_interventions.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "backend_npc_intervention_candidates" => db_update.backend_npc_intervention_candidates.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "backend_physical_evidence" => db_update.backend_physical_evidence.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "backend_physical_evidence_inspections" => db_update.backend_physical_evidence_inspections.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "backend_physiology_administrations" => db_update.backend_physiology_administrations.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "backend_physiology_charts" => db_update.backend_physiology_charts.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                "backend_social_addresses" => db_update.backend_social_addresses.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
                ...
                "starting_character_claim" => db_update.starting_character_claim.append(__sdk::parse_row_list_as_deletes(table_rows.rows)?),
...
pub struct AppliedDiff<'r> {
    ...
    backend_investigation_action_outcomes: __sdk::TableAppliedDiff<'r, BackendInvestigationActionOutcome>,
    ...
    backend_npc_intervention_candidates: __sdk::TableAppliedDiff<'r, BackendNpcInterventionCandidate>,
    backend_physical_evidence: __sdk::TableAppliedDiff<'r, BackendPhysicalEvidence>,
    backend_physical_evidence_inspections: __sdk::TableAppliedDiff<'r, BackendPhysicalEvidenceInspection>,
    backend_physiology_administrations: __sdk::TableAppliedDiff<'r, BackendPhysiologyAdministration>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(&self, event: &EventContext, callbacks: &mut __sdk::DbCallbacks<RemoteModule>) {
        ...
        callbacks.invoke_table_row_callbacks::<AutomaticSocialChat>("backend_automatic_social_chats", &self.backend_automatic_social_chats, event);
        ...
        callbacks.invoke_table_row_callbacks::<BackendForageReceipt>("backend_forage_receipts", &self.backend_forage_receipts, event);
        callbacks.invoke_table_row_callbacks::<BackendInvestigationActionOutcome>("backend_investigation_action_outcomes", &self.backend_investigation_action_outcomes, event);
        callbacks.invoke_table_row_callbacks::<BackendInvestigationAction>("backend_investigation_actions", &self.backend_investigation_actions, event);
        callbacks.invoke_table_row_callbacks::<BackendInvestigationCaseSummary>("backend_investigation_cases", &self.backend_investigation_cases, event);
        ...
        callbacks.invoke_table_row_callbacks::<BackendLocalChatMessage>("backend_local_chat_messages", &self.backend_local_chat_messages, event);
        ...
        callbacks.invoke_table_row_callbacks::<BackendNpcCaseIntervention>("backend_npc_case_interventions", &self.backend_npc_case_interventions, event);
        callbacks.invoke_table_row_callbacks::<BackendNpcInterventionCandidate>("backend_npc_intervention_candidates", &self.backend_npc_intervention_candidates, event);
        callbacks.invoke_table_row_callbacks::<BackendPhysicalEvidence>("backend_physical_evidence", &self.backend_physical_evidence, event);
        callbacks.invoke_table_row_callbacks::<BackendPhysicalEvidenceInspection>("backend_physical_evidence_inspections", &self.backend_physical_evidence_inspections, event);
        callbacks.invoke_table_row_callbacks::<BackendPhysiologyAdministration>("backend_physiology_administrations", &self.backend_physiology_administrations, event);
        callbacks.invoke_table_row_callbacks::<BackendPhysiologyChart>("backend_physiology_charts", &self.backend_physiology_charts, event);
        callbacks.invoke_table_row_callbacks::<SocialAddress>("backend_social_addresses", &self.backend_social_addresses, event);
        ...
        callbacks.invoke_table_row_callbacks::<StartingCharacterClaim>("starting_character_claim", &self.starting_character_claim, event);
