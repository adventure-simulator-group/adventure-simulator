...
#[sats(crate = __lib)]
pub(super) struct ContinueCampTravelArgs {
    pub character_id: u64,
}

impl From<ContinueCampTravelArgs> for super::Reducer {
...
/// Extension trait for access to the reducer `continue_camp_travel`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait continue_camp_travel {
...
impl continue_camp_travel for super::RemoteReducers {
    fn continue_camp_travel_then(
        &self,
        character_id: u64,
