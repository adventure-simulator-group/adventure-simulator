...
#[sats(crate = __lib)]
pub(super) struct BeginApprenticeshipArgs {
    pub character_id: u64,
    pub service_id: String,
}

impl From<BeginApprenticeshipArgs> for super::Reducer {
    fn from(args: BeginApprenticeshipArgs) -> Self {
...
/// Extension trait for access to the reducer `begin_apprenticeship`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait begin_apprenticeship {
...
impl begin_apprenticeship for super::RemoteReducers {
    fn begin_apprenticeship_then(
        &self,
        character_id: u64,
        service_id: String,
