...
pub struct BackendInvestigationActionCols {
    ...
    pub duration_minutes: __sdk::__query_builder::Col<BackendInvestigationAction, u32>,
    pub fatigue: __sdk::__query_builder::Col<BackendInvestigationAction, u16>,
    pub food_units: __sdk::__query_builder::Col<BackendInvestigationAction, u16>,
    pub water_units: __sdk::__query_builder::Col<BackendInvestigationAction, u16>,
...
impl __sdk::__query_builder::HasCols for BackendInvestigationAction {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        BackendInvestigationActionCols {
            ...
            food_units: __sdk::__query_builder::Col::new(table_name, "food_units"),
            water_units: __sdk::__query_builder::Col::new(table_name, "water_units"),
