...
pub struct LocalProblemReceiptCols {
    ...
    pub source_resident_character_id: __sdk::__query_builder::Col<LocalProblemReceipt, u64>,
...
impl __sdk::__query_builder::HasCols for LocalProblemReceipt {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        LocalProblemReceiptCols {
            ...
            contact_resident_character_id: __sdk::__query_builder::Col::new(
                table_name,
                "contact_resident_character_id",
            ),
