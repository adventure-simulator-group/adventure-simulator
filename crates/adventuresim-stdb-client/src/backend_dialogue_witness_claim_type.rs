...
pub struct BackendDialogueWitnessClaimCols {
    ...
    pub charm_response: __sdk::__query_builder::Col<BackendDialogueWitnessClaim, Option<String>>,
    pub command_response: __sdk::__query_builder::Col<BackendDialogueWitnessClaim, Option<String>>,
