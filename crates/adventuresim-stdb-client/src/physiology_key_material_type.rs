...
impl __sdk::__query_builder::HasCols for PhysiologyKeyMaterial {
    type Cols = PhysiologyKeyMaterialCols;
    fn cols(table_name: &'static str) -> Self::Cols {
        PhysiologyKeyMaterialCols {
...
/// Indexed column accessor struct for the table `PhysiologyKeyMaterial`.
///
/// Provides typed access to indexed columns for query building.
pub struct PhysiologyKeyMaterialIxCols {
    pub id: __sdk::__query_builder::IxCol<PhysiologyKeyMaterial, u8>,
}

impl __sdk::__query_builder::HasIxCols for PhysiologyKeyMaterial {
    type IxCols = PhysiologyKeyMaterialIxCols;
