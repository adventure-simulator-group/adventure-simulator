...
pub trait begin_world_data_import {
    ...
    fn begin_world_data_import(&self, schema_version: u32,
artifact_id: String,
manifest_digest: String,
sources: String,
) -> __sdk::Result<()> {
        self.begin_world_data_import_then(schema_version, artifact_id, manifest_digest, sources,  |_, _| {})
    }
...
sources: String,
        ...
        self.imp.invoke_reducer_with_callback(BeginWorldDataImportArgs { schema_version, artifact_id, manifest_digest, sources,  }, callback)
    }
}
