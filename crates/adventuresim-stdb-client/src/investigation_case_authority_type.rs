...
pub struct InvestigationCaseAuthorityCols {
...
impl __sdk::__query_builder::HasCols for InvestigationCaseAuthority {
    type Cols = InvestigationCaseAuthorityCols;
    fn cols(table_name: &'static str) -> Self::Cols {
        InvestigationCaseAuthorityCols {
...
/// Indexed column accessor struct for the table `InvestigationCaseAuthority`.
///
/// Provides typed access to indexed columns for query building.
pub struct InvestigationCaseAuthorityIxCols {
    pub id: __sdk::__query_builder::IxCol<InvestigationCaseAuthority, String>,
}

impl __sdk::__query_builder::HasIxCols for InvestigationCaseAuthority {
    type IxCols = InvestigationCaseAuthorityIxCols;
