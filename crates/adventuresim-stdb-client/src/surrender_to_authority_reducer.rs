...
impl __sdk::InModule for SurrenderToAuthorityArgs {
    type Module = super::RemoteModule;
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `surrender_to_authority`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait surrender_to_authority {
...
impl surrender_to_authority for super::RemoteReducers {
    fn surrender_to_authority_then(
        &self,
        character_id: u64,
        action_token: String,
