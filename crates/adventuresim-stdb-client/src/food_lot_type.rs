...
pub struct FoodLotCols {
    ...
    pub salty_kg: __sdk::__query_builder::Col<FoodLot, f32>,
    pub spicy_kg: __sdk::__query_builder::Col<FoodLot, f32>,
    pub sweet_kg: __sdk::__query_builder::Col<FoodLot, f32>,
    pub sour_kg: __sdk::__query_builder::Col<FoodLot, f32>,
    pub savory_kg: __sdk::__query_builder::Col<FoodLot, f32>,
    pub quality: __sdk::__query_builder::Col<FoodLot, u8>,
