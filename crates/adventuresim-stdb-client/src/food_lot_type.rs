...
impl __sdk::__query_builder::HasCols for FoodLot {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        FoodLotCols {
            ...
            ingredient_item_ids: __sdk::__query_builder::Col::new(table_name, "ingredient_item_ids"),
            ingredient_quantities: __sdk::__query_builder::Col::new(table_name, "ingredient_quantities"),
