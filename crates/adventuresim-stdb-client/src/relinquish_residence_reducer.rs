...
impl __sdk::InModule for RelinquishResidenceArgs {
    type Module = super::RemoteModule;
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `relinquish_residence`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait relinquish_residence {
...
impl relinquish_residence for super::RemoteReducers {
    fn relinquish_residence_then(
        &self,
        character_id: u64,
