...
1. SpacetimeDB running locally with `strategic-db` module published
2. Rust toolchain
...
# Publish the strategic-db module
spacetime publish strategic-db --project-path crates/strategic-db

# Seed the world (optional)
spacetime call strategic-db seed_world
```
