...
fn camp_schedule(allocation: &ScheduleAllocation) -> DailySchedule {
    DailySchedule {
        ...
        insight: allocation.insight_minutes,
        self_awareness: allocation.self_awareness_minutes,
        humor: allocation.humor_minutes,
        command: allocation.command_minutes,
        deception: allocation.deception_minutes,
        seduction: allocation.seduction_minutes,
