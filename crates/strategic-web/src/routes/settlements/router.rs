...
use crate::spacetimedb::{
    ...
    CharacterMoraleSource, CharacterNeeds, CharacterPersonality, CharacterResidence,
    ...
    EquipmentAnchorKind, EquipmentAttachmentTarget, EquipmentOccupancy, ExclusiveCommitment,
    FoodLot, InventoryItem, InventoryItemAmount, InventoryQuantityTarget, ItemCondition,
    ItemDefinition, ItemKind, ItemSlot, LimbInjury, LimbRegion, Party, PartyInventoryItem,
    PartyJourney, PartyJourneyItinerary, PartyJourneyRoute, PartyMember, PartyRecruitmentRole,
    PartyStake, RecruitmentOffer, RecruitmentOfferStatus, RecruitmentRequirements, ReligiousDemand,
    RepairOrder, ResidenceOccupant, ResidenceTier, RetainedProjectile, ScheduleAllocation,
    Settlement, SettlementAlias, SettlementDescription, SettlementResidenceOffer, SettlementSmith,
