...
pub fn merchants_page(settlement: &Settlement, logged_in_as: Option<&str>, theme: &str) -> Markup {
    service_placeholder_page(settlement, "merchants", "Merchants", "Buy and sell goods here.", logged_in_as, theme)
}

/// Smith page placeholder
pub fn smith_page(settlement: &Settlement, logged_in_as: Option<&str>, theme: &str) -> Markup {
    service_placeholder_page(settlement, "smith", "The Smithy", "Repair and upgrade equipment here.", logged_in_as, theme)
}

/// Inn page placeholder
pub fn inn_page(settlement: &Settlement, logged_in_as: Option<&str>, theme: &str) -> Markup {
    service_placeholder_page(settlement, "inn", "The Inn", "Rest and recover here.", logged_in_as, theme)
}
