    ...
    html! {
        ...
        html lang="en" {
            head {
                ...
                link rel="stylesheet" href="/static/css/base.css?v=environment-9";
                // Shared CSS
                link rel="stylesheet" href="/static/css/reset.css";
                link rel="stylesheet" href="/static/css/layout.css?v=environment-9";
                link rel="stylesheet" href="/static/css/components.css?v=game-icons-2";
                link rel="stylesheet" href="/static/css/strategic.css?v=environment-9";
                link rel="stylesheet" href="/static/css/utilities.css?v=environment-9";
