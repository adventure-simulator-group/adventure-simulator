    ...
    html! {
        ...
        html lang="en" {
            head {
                ...
                link rel="stylesheet" href="/static/css/layout.css?v=left-rail-scrollbars-1";
                link rel="stylesheet" href="/static/css/components.css?v=game-icons-2";
                link rel="stylesheet" href="/static/css/strategic.css?v=inventory-browser-15-religion-3";
