    ...
    html! {
        ...
        html lang="en" {
            head {
                ...
                link rel="stylesheet" href="/static/css/strategic.css?v=strategic-ui-overhaul-4-paper-map-2-data-license-1-grouped-alcohol-2-rest-supplies-1";
                ...
                @if scripts == ScriptProfile::Strategic {
                    ...
                    script src="/static/inventory-browser.js?v=coin-currencies-3-alcohol-targets-1" defer {}
