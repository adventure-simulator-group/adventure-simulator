    ...
    html! {
        ...
        html lang="en" {
            head {
                ...
                link rel="stylesheet" href="/static/css/strategic.css?v=inventory-browser-15-religion-5-travel-rails-3";
                ...
                @if scripts == ScriptProfile::Strategic {
                    ...
                    script src="/static/travel-planner.js?v=travel-rails-4" defer {}
