    ...
    html! {
        ...
        html lang="en" {
            head {
                ...
                link rel="stylesheet" href="/static/css/strategic.css?v=candidate-inventory-3-item-yaml-editor-1-claim-challenges-1-equipment-slots-3";
                ...
                @if scripts == ScriptProfile::Strategic {
                    ...
                    script src="/static/equipment-toggle.js?v=location-keyboard-slots-1" defer {}
                ...
                script src="/static/physiology-dialog.js?v=visual-notebook-2" defer {}
                    ...
                    script src="/static/dialogue-client.js?v=counterparty-portraits-1-claim-challenges-2" defer {}
