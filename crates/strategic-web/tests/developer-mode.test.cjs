...
test("dialogue edit URL and catalog revision are server generated", () => {
  assert.match(settlement, /github_edit_url/);
  assert.match(settlement, /data-dialogue-source-url/);
