...
pub mod prelude {
    ...
    pub use crate::animation::{
        ...
        WALK_LOCOMOTION_PROFILE, WeaponGuardState, advance_body_facing, advance_body_facing_toward,
        advance_body_facing_with_speed, advance_downed_body_facing,
        advance_downed_body_facing_with_speed, body_turn_speed_for_deadline, controller_yaw,
        dive_landing_facing_delta, downed_camera_roll_target, gait_cycle_phase_delta,
        gait_support_weights, guard_closed_foot_separation, guard_contact_travel_distance,
