...
| <kbd>CAPS LOCK</kbd> | | Toggle walking/jogging. | Jogging is the default. Its sustainable speed is determined by Endurance; walking is always 1.4 m/s. |
| <kbd>SHIFT</kbd> | | Sprint. | Sprinting begins immediately. Release after holding longer than 0.25 seconds to stop; a shorter tap latches sprint until Shift is pressed again. Sprint speed is determined by average leg Strength and falls toward sustainable jogging speed as breath is exhausted. |
| LMB | RT | Attack! | |
