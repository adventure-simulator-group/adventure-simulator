...
| RMB + <kbd>Shift</kbd> while still | LT + RB while still | Duck. | Ducking is a lasting crouch while the chord is held. "Still" is determined from movement input, not current velocity. Keyboard aim/block + Space is reserved for quickstep. |
