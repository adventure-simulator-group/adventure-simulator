...
penetration and a greater-than-5 cm moving pelvis step with contact safety;
sustained stance-width errors with both-feet-behind; sustained swing-foot
scuffing and terrain-normal-relative contact orientation with dragging; and
moving-cadence duration irregularity with jitter. Final post-propagation foot
records include both the rendered sole normal and terrain normal. Contact
orientation compares them against the same 28-degree terrain-normal clamp used
by production slope alignment, and becomes a failure only when its 5-degree
error persists for at least one quarter stride.
