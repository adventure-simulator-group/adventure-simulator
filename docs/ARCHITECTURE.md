...
The accepted future architecture for fractional consumables is specified in
...
Production inventory tables have not yet adopted that schema; current food
lots, whole-unit alcohol/soap, and direct weight calculations remain rollout
work identified by that document.
