...
| `update_party_check_targets` | Configure non-filtering Medicine, Charisma, and Religion aggregate goals; surgical capability is an individual Anatomy/Knife/Tailoring composite |
