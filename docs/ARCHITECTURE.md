...
adds a nonempty modeled-or-inferred tree-species profile, and constructs the
canonical settlement record. The generic draft is a typestate boundary: each enrichment
