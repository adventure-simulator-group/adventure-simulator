...
from 6 mm chord and 0.3 mm sagitta budgets, with a twelve-sided floor and any
higher explicit segment request preserved.
...
The initial library contains twenty-one presets spanning halberds, hammers,
...
Approximate volume is a mesh diagnostic; mass, center of mass, inertia,
colliders, UVs, export, and production topology remain future work.
