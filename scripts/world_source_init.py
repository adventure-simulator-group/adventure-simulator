...
CONTRACTS = {
    ...
    "luh1": Contract("luh1-luha-u2-v1", "LUHa_u2.v1", "manual-acquisition", "rights reserved; follow official acquisition terms",
        "https://doi.org/10.3334/ORNLDAAC/1248", "10.3334/ORNLDAAC/1248",
        "target/world-data-sources/raw/luh1-land-use",
        ("LUHa_u2.v1_gcrop.nc4", "LUHa_u2.v1_gpast.nc4", "LUHa_u2.v1_gurbn.nc4", "LUHa_u2.v1_gothr.nc4", "LUHa_u2.v1_gsecd.nc4"),
        "EPSG:4326", "0.5 degree", "1500–2100 CE",
        "place the five official annual NetCDF state files in the configured directory",
        "the five manually acquired LUH1 NetCDF files are rights-reserved and not content-pinned"),
