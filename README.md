...
The prototype's first-character flow presents five deterministic generated mortal candidates rather than a customization form. Candidate state is kept in the browser tab until one is confirmed; confirmation authoritatively regenerates and persists only the selected character.
