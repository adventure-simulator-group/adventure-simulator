...
animation-motion-graph trace output="target/animation-motion/r-weapon.svg" bone="r_weapon" cycle="-1":
    @{{ python_bin }} scripts/plot_animation_motion_trace.py {{ quote(trace) }} --output {{ quote(output) }} --bone {{ quote(bone) }} --cycle {{ quote(cycle) }}
